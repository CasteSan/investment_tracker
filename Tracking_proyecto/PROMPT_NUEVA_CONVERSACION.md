...
# Actualizado después de Sesión 5 (Dividends Module)
# =============================================================================
...
# 6. Ver dividendos
python test_dividends.py --create-examples  # Primera vez
...
- Comparación con índices (IBEX 35, S&P 500, MSCI World, Euro Stoxx 50)
- Normalización base 100 para comparar visualmente
- Cálculo de outperformance/underperformance
- Descarga de datos históricos con yfinance (opcional, requiere internet)
- Comparación parcial (ej: solo acciones españolas vs IBEX)
- Estadísticas: volatilidad, tracking error, Sharpe ratio

#### Sesión 7+: Streamlit UI (`app/`)
- Dashboard interactivo con métricas clave
- Formularios para registrar operaciones
- Gráficos interactivos con Plotly
- Páginas: Dashboard, Añadir Operación, Análisis, Fiscal, Dividendos, Benchmarks
...
**Nota**: Si necesitas ver el código actual de algún módulo, pídemelo y te lo comparto. Los archivos principales son `database.py`, `data_loader.py`, `portfolio.py`, `tax_calculator.py`, `dividends.py` y `convert_investing_csv.py`.
