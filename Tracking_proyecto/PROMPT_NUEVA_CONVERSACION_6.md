...
# Actualizado después de Sesión 6 (Benchmarks Module)
# =============================================================================
...
- Formularios para registrar operaciones manualmente
- Gráficos interactivos con Plotly
- Páginas multipágina:
  - 📊 Dashboard (resumen general)
  - ➕ Añadir Operación (formularios)
  - 📈 Análisis (rentabilidad por activo)
  - 💰 Fiscal (plusvalías, informes para declaración)
  - 💵 Dividendos (calendario, yield)
  - 🎯 Benchmarks (comparación con índices)

#### Sesión 8+: Mejoras y Expansiones
- Market Data Module: Precios actuales con yfinance
- Alertas de dividendos próximos
